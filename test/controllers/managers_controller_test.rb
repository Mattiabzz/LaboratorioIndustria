...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { cognome: @manager.cognome, email: @manager.email, nome: @manager.nome } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { cognome: @manager.cognome, email: @manager.email, nome: @manager.nome } }
